                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">Data Instructors</div>
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php 
                                                $no = 1;
                                                while($rowInstructor = mysqli_fetch_assoc($queryInstructors)) : 
                                                ?>
                                                <tr>
                                                    <td><?php echo $no++ ?></td>
                                                    <td>
                                                      <style>
                                                        .instructor-table-photo {
                                                          border-radius: 10px;
                                                          width: 150px;
                                                          border: solid 1px black;
                                                        }
                                                      </style>
                                                      <img class="instructor-table-photo" src="upload/<?php echo $rowInstructor['photo'] ?>" alt="Instructor's Photo">
                                                    </td>
                                                    <td><?php echo $rowInstructor['instructor_name'] ?></td>
                                                    <td><?php echo $rowInstructor['instructor_major'] ?></td>
                                                    <td>
                                                        <a class="btn btn-success" href="add-instructor.php?edit=<?php echo $rowInstructor['id'] ?>">
                                                        ...
                                                        <a onclick="return confirm ('Apakah anda yakin akan menghapus data ini?')" class="btn btn-danger"
                                                            href="add-instructor.php?delete=<?php echo $rowInstructor['id'] ?>">
